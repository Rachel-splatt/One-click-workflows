...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const workflowNameInput = document.getElementById('name');
    ...
    function setCheckedButton(button) {
        ...
        console.log('Button checked:', (_a = button.textContent) === null || _a === void 0 ? void 0 : _a.trim());
    }
    // Set initial state based on sessionStorage data
    if (workflowType) {
        const triggerButton = document.querySelector(`button[data-workflow-type="${workflowType}"]`);
